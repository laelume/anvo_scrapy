...
def show_help():
    ...
    help_text = """
anvo_scrapy - Animal Vocalization Scraper
=========================================
...
EXAMPLES:
    python anvo_scrapy.py -s "kiwi" -q A -l 10
    python anvo_scrapy.py --species "owl" --limit unlimited --quality B
    python anvo_scrapy.py -s "Corvus" -q A -l 20 -d 2
    python anvo_scrapy.py -s "cardinal" -d 0.5
    python anvo_scrapy.py -s "eagle" -o "raptors" -q B

SPECIAL COMMANDS:
    python anvo_scrapy.py --help          Show this help
    python anvo_scrapy.py --examples      Show usage examples
    python anvo_scrapy.py --qualities     Show quality rating info
"""
    print(help_text)
...
Scientific Name Search:
    python anvo_scrapy.py -s "Corvus" -q A -l 20
...
Any Quality, Any Duration:
    python anvo_scrapy.py -s "loon" -l unlimited -d unlimited
...
def main():
    ...
    if not args.species:
        ...
        print("Use: python anvo_scrapy.py --help for detailed instructions")
        print("\nQuick example:")
        print("python anvo_scrapy.py -s 'kiwi' -q A")
        return
    ...
    try:
        ...
        # Download sounds
        print(f"anvo_scrapy - Downloading {args.species} sounds...")
        print("=" * 50)
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        print("anvo_scrapy - Animal Vocalization Scraper")
        print("Use --help for detailed instructions")
        print("\nQuick start:")
        print("python anvo_scrapy.py -s 'kiwi' -q A")
        print("python anvo_scrapy.py --examples")
    else:
        main()
